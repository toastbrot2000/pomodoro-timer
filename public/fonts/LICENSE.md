...
The bundled web fonts are licensed under the **SIL Open Font License, Version 1.1**,
which permits bundling and redistribution (including with this MIT-licensed app).
...
(SIL OFL 1.1). The license terms are reproduced below.
